      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {APP_CONTENT.legacy.ancestors.map((ancestor, index) => {
            ...
            // Check if this is A.K. Vilvam to show the Read More link
            const isAKVilvam = ancestor.name === "A.K. Vilvam (MLC)";
            ...
            return (
              ...
              >
                ...
                {/* Read More Link for A.K. Vilvam */}
                {isAKVilvam && (
                  <Link
                    to="/blog/ak-vilvam"
                    className="mt-4 inline-flex items-center gap-2 text-red-400 hover:text-red-300 text-sm font-semibold transition-colors duration-300 group/link"
                  >
                    <span>Read More</span>
